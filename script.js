...
async function getGoldData() {
    ...
    const url = `${API_BASE_URL}?function=TIME_SERIES_DAILY&symbol=XAUUSD&outputsize=full&apikey=${API_KEY}`;
    try {
        ...
        // Rielaborazione dei dati per ottenere un formato simile a quello di Goldapi
        ...
        return { prices }; // Restituisco un oggetto con la chiave 'prices'
    } catch (error) {
